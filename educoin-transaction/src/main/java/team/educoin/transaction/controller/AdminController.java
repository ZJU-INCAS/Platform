...
public class AdminController {
    ...
    public CommonResponse extractServiceInfo(@PathVariable("id") String id) throws FileNotFoundException, IOException, InterruptedException {
